    ...
    <div className="relative flex w-full justify-end text-left">
      <div>
        <button
          ...
          className="inline-flex w-full items-center justify-center gap-x-1.5 rounded-md bg-teal-500 px-3 py-2 text-sm font-semibold text-white transition-colors hover:bg-teal-600"
        >
